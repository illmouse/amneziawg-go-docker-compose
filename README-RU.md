...
| Параметры обфускации (`Jc`, `Jmin`, `Jmax`, `S1`, `S2`, `H1`, `H2`, `H3`, `H4`) | [описание параметров](https://docs.amnezia.org/documentation/amnezia-wg/#how-it-works)          | генерируется автоматически скриптом `setup.sh` |                  |
