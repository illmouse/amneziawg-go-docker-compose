...
* Прозрачный прокси-сервер SQUID для проксирования запросов через контейнер в клиентском режиме
...
| SQUID_ENABLED       | `true`, `false`                 | `true`                            | Включение прокси-сервера SQUID в клиентском режиме                                                                     |
| SQUID_PORT          | 1–65535                         | `3128`                            | Порт, на котором будет запущен SQUID                                                                                   |
