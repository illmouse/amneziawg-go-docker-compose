...
export PROXY_ENABLED PROXY_PORT_HTTP PROXY_PORT_SOCKS5 PROXY_LOG_DIR PROXY_AUTH_SOCKS5_ENABLED PROXY_AUTH_SOCKS5_USER PROXY_AUTH_SOCKS5_PASSWORD_HASH  PROXY_AUTH_HTTP_ENABLED PROXY_AUTH_HTTP_USER PROXY_AUTH_HTTP_PASSWORD_HASH PROXY_CUSTOM_CONFIG
