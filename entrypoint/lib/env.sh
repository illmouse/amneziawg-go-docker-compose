...
export PROXY_SOCKS5_ENABLED PROXY_HTTP_ENABLED PROXY_HTTP_PORT PROXY_SOCKS5_PORT PROXY_LOG_DIR PROXY_SOCKS5_AUTH_ENABLED PROXY_SOCKS5_AUTH_USER PROXY_SOCKS5_AUTH_PASSWORD PROXY_HTTP_AUTH_ENABLED PROXY_HTTP_AUTH_USER PROXY_HTTP_AUTH_PASSWORD PROXY_CUSTOM_CONFIG
